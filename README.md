...
* [https://github.com/id5io/id5-api.js/releases/download/v1.0.9/id5-api.js](https://github.com/id5io/id5-api.js/releases/download/v1.0.9/id5-api.js)
...
- allowedVendors - an array of strings which can be 
  - the [IAB GVL](https://iabeurope.eu/vendor-list-tcf-v2-0/) ID of the partner
  - and ID5 partner ID in the form "ID5-xxx" with xxx being the id
