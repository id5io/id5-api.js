...
* [https://github.com/id5io/id5-api.js/releases/download/v1.0.96/id5-api.js](https://github.com/id5io/id5-api.js/releases/download/v1.0.96/id5-api.js)

Alternatively, we also publish the minified bundle to NPM:
```json
  "dependencies": {
    "@id5io/id5-api.js": "^1.0.96"
  },
```
...
| exposeTargeting                       | Optional                                     | boolean | `false`                                  | When set, the ID5 targeting consumer mechanism will be enabled.                                                                                                                                                         |
| idLookupMode                          | Optional                                     | boolean | `false`                                  | When set, ID5 API will function in lookup mode, not creating any new ids. It also won't join ID5 multiplexing communication with other ID5 instances on the page. This mode needs to be enabled on partner level        |
...
```
# Npm version
We use npm version 18 in testing. There is .nvmrc so you can enforce npm version with:
