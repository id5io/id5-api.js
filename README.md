...
| idLookupMode                          | Optional                                     | boolean | `false`                                  | When set, ID5 API will function in lookup mode, not creating any new ids. This mode needs to be enabled on partner level                                                                                                 |
