 ...
 * @property {number} [publishInMsec] - Delay in ms after which collected diagnostics are published
 * @property {boolean} [publishOnUnload] - When true, diagnostics publishing is triggered on 'unload' event
 */
  ...
  constructor(invocationId, options) {
    ...
    this.options = {
      ...
      diagnostics: {
        ...
        publishInMsec: 300000,
        publishOnUnload: true
      }
    };
