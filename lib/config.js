...
export class StorageConfig {
  ...
  #defaultStorageConfig = STORAGE_CONFIG;

  constructor(storageExpirationDays = undefined) {
    this.#storageExpirationDays = storageExpirationDays;
    this.ID5 = this.#createConfig(this.#defaultStorageConfig.ID5);
    this.LAST = this.#createConfig(this.#defaultStorageConfig.LAST);
    this.CONSENT_DATA = this.#createConfig(this.#defaultStorageConfig.CONSENT_DATA);
    this.PD = this.#createConfig(this.#defaultStorageConfig.PD);
    this.PRIVACY = this.#createConfig(this.#defaultStorageConfig.PRIVACY);
    this.SEGMENTS = this.#createConfig(this.#defaultStorageConfig.SEGMENTS);
    this.LIVE_INTENT = this.#createConfig(this.#defaultStorageConfig.LIVE_INTENT);
  }

  #createConfig(defaultConfig) {
    let expiresDays = this.#storageExpirationDays !== undefined ? Math.max(1, this.#storageExpirationDays) : defaultConfig.expiresDays;
