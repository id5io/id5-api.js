...
import {NoopLogger, StorageConfig} from '@id5io/multiplexing';
 ...
 * @property {boolean|false} [disabled] - Disable multiplexing (instance will work in single mode)
 */
...
export default class Config {
   ...
   * @param {Logger} logger
   */
  constructor(options, logger = NoopLogger) {
    this._log = logger;
    this.options = {
