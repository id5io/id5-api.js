...
import { delve, isPlainObject, isStr, logInfo } from './utils.js';

/* eslint-disable no-unused-vars */
import LocalStorage from './localStorage.js';
/* eslint-enable no-unused-vars */

const LIVE_INTENT_POLL_INTERVAL_MS = 500;
...
export class LiveIntentApi {
  ...
  constructor(isEnabled, invocationId, localStorage) {
    const self = this;
  ...
  _onDetected() {
    ...
    const resolve = delve(window, 'liQ.resolve');
    resolve(result => {
