...
import {ConsentManagement} from '@id5io/multiplexing';
...
export default class Id5Status {
   ...
   */
  constructor(invocationId, config, clientStore, consentManagement, liveIntentApi, metrics, consentDataProvider, logger, instance) {
