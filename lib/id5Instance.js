...
class UnregisterTargets {
  ...
  constructor(...targets) {
    this._targets = Array.of(...targets);
  }
...
export class Id5Instance {
  ...
  unregister() {
    try {
      this._unregisterTargets.unregister();
  ...
  /**
   * @return {WeakRef<Id5Instance>|WeakRefPolyfill}
   * @private
   */
  _weakRef() {
    ...
    return new WeakRefPolyfill(this);
  }
