...
import {API_TYPE, ConsentData, GppConsentData, ID5_GVL_ID, NoopLogger} from '@id5io/multiplexing';
...
export class GPPClient {
  ...
  static async create(log) {
    ...
    if (isFn(gppApiFunction)) {
      ...
      const surrogate = ConsentDataProvider._buildCmpSurrogate('gppv1', gppApiFrame);
