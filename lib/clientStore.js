...
import {cyrb53Hash, getCookie, isEmpty, logError, logWarn, setCookie} from './utils.js';
...
export default class ClientStore {
  ...
  isStoredPdUpToDate(partnerId, currentPd) {
    ...
    let currentCantReplaceStored = isEmpty(currentPd) && !isEmpty(storedPdHash);
    return currentCantReplaceStored ||
      ClientStore.storedDataMatchesCurrentData(storedPdHash, ClientStore.makeStoredHash(currentPd));
  }
