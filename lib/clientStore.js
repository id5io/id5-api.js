...
export default class ClientStore {
   ...
   */
  constructor(invocationId, localStorageAllowedCallback, localStorage) {
  ...
  get(cacheConfig) {
    try {
      if (this.localStorageAllowedCallback() === true) {
        ...
        logWarn(this.invocationId, 'clientStore.get() has been called without localStorageAllowed');
      }
    } catch (e) {
  ...
  put(cacheConfig, data) {
    try {
      if (this.localStorageAllowedCallback() === true) {
        ...
        logWarn(this.invocationId, 'clientStore.put() has been called without localStorageAllowed');
      }
    } catch (e) {
      logError(this.invocationId, e);
    }
