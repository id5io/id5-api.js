...
export default class ClientStore {
   ...
   * @param {boolean} restrictWrites if true, then writes to local storage are restricted
   */
  constructor(localStorageAllowedCallback, driver, restrictWrites) {
    this.localStorageAllowedCallback = localStorageAllowedCallback;
    this.driver = driver;
    this.restrictWrites = restrictWrites;
  }
  /**
