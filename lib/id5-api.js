...
class Id5Api {
  ...
  constructor() {
    ...
    this.localStorageDriver = new LocalStorage(window.top);

    this.clientStore = new ClientStore(() => { return currentThis.localStorageAllowed }, this.localStorageDriver);
  }
  ...
  init(options) {
    ...
    try {
      ...
      this.consent = new ConsentManagement(this.localStorageDriver);
