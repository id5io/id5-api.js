...
import multiplexing, {ApiEvent, ClientStore, ConsentManagement, LocalStorage, Promise, WindowStorage} from '@id5io/multiplexing';
...
class Id5Api {
  ...
  init(passedOptions) {
    ...
    try {
      ...
      const storage = new WindowStorage(window, !options.applyCreativeRestrictions);
