...
class Id5Api {
  ...
  gatherData(options, id5Status, nb, consentData, storedResponse, uaHints) {
    // For backward compatibility reasons both 'rf' and 'tml' represent topmostLocation.
    // The 'rf' will be removed by the next refactoring iteration
    const data = {
      'partner': options.partnerId,
      'v': this._version,
      'o': 'api',
      'rf': this._referer.topmostLocation,
